...
1. Launch Squiggy
2. Click the **"Open POD5 File"** button
...
3. Check the **"Show base annotations"** checkbox
4. Select a read to view the annotated squiggle plot

**Requirements:**
- The BAM file must contain move tables (generated by modern Oxford Nanopore basecallers)
...
- **Base Annotations**: If enabled, bases will be shown as colored rectangles (A=green, C=blue, G=orange, T=red)
