...
```
python scripts/create_test_data.py --input-pod5 ~/Leu_aux_SC_rep_1.pod5 --input-bam ~/Leu_aux_SC_rep_1.bam --references tRNA-Ala-AGC-1-1-uncharged,tRNA-Trp-CCA-1-1-uncharged,tRNA-iMet-CAT-1-1-uncharged  --output-prefix=yeast_trna --min-mapq 10
```

### YEAST_TRNA Files (Multi-read testing)
