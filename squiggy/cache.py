...
class SquiggyCache:
    ...
    Attributes:
        cache_dir: Directory to store cache files (default: ~/.local/squiggy/cache)
    ...
    def __init__(self, cache_dir: Path | None = None, enabled: bool = True):
        ...
        Args:
            cache_dir: Directory for cache files (default: ~/.local/squiggy/cache)
            enabled: Whether caching is enabled
        """
        self.cache_dir = cache_dir or Path.home() / ".local" / "squiggy" / "cache"
