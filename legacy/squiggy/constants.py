...
# Modification classification scopes
MOD_SCOPE_POSITION = "position"  # Per-position classification
MOD_SCOPE_ANY = "any"  # Any modification in visible region

# Modification track settings (for aggregate mode)
MOD_TRACK_HEIGHT = 200  # Height in pixels for modification heatmap track
MOD_HEATMAP_COLORBAR_WIDTH = 100  # Width of colorbar in pixels
